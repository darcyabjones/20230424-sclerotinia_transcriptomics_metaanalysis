...
wcounts <- wcounts[(!is.na(gene_sds)) & (gene_sds > 0) & (rowSums(wcounts, na.rm = TRUE) > 0), ]
norm_factors <- calcNormFactors(wcounts)
wcounts <- (wcounts - colMeans(wcounts)) / norm_factors
